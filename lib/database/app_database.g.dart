    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ItemJob` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `position` TEXT NOT NULL, `company` TEXT NOT NULL)');
...
class _$ItemDAO extends ItemDAO {
  ...
  final InsertionAdapter<ItemJob> _itemJobInsertionAdapter;

  final DeletionAdapter<ItemJob> _itemJobDeletionAdapter;

  @override
  Future<List<ItemJob>> findAll() async {
    return _queryAdapter.queryList('SELECT * FROM ItemJob',
        mapper: (Map<String, Object?> row) => ItemJob(
            id: row['id'] as int?,
